    ...
    <div className="App">
     <div className="maincontainer">
        <div id="preloder">
            ...
            <div class="col-lg-6 p-0">
            <div class="categories__item categories__large__item set-bg" data-setbg="assets/img/categories/category-6.jpg">
            <div class="categories__text">
            <h1>Men’s fashion</h1>
            <p>358 items</p>
